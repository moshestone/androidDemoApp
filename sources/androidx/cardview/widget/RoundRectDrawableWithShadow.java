...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, f4, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, startRatio, 1.0f}, TileMode.CLAMP);
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, f8, 0.0f, f9, iArr, new float[]{0.0f, 0.5f, 1.0f}, TileMode.CLAMP);
