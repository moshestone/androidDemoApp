...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            if (z2) {
                ...
                if (shouldLayout) {
                    ...
                    i14 = measuredHeight + layoutParams5.bottomMargin;
                } else {
                    i17 = i7;
                }
                if (shouldLayout2) {
                    LayoutParams layoutParams6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i24 = i14 + layoutParams6.topMargin;
                ...
                if (shouldLayout) {
                    ...
                    i14 = measuredHeight2 + layoutParams7.bottomMargin;
                } else {
                    i15 = max;
                }
                if (shouldLayout2) {
                    LayoutParams layoutParams8 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i27 = i14 + layoutParams8.topMargin;
        ...
        for (int i29 = 0; i29 < size; i29++) {
            max = layoutChildLeft((View) this.mTempViews.get(i29), max, iArr, i11);
        }
        int i30 = i11;
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i31 = 0; i31 < size2; i31++) {
            i7 = layoutChildRight((View) this.mTempViews.get(i31), i7, iArr, i30);
        }
        ...
        while (i13 < size3) {
            max = layoutChildLeft((View) this.mTempViews.get(i13), max, iArr, i30);
            i13++;
        }
